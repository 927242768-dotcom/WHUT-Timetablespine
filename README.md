...
- APK 内实际包名 `com.whut.timetable`、versionCode `18`、versionName `1.6.0`
- 回归验证：9/1 不会再匹配 9/7–9/13 的第一教学周课程
- 周览支持连续节次课程块并横向查看周末
- 课程详情采用彩色顶部与分组信息行
...
`EF6D5FA56CA93267104714E84CA47B0B2E31D51453845E06B68B3BBDBB6595D8`
